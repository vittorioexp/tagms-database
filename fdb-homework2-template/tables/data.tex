...
\multirow{3}{*}{Specify} & Item\_ID & Identifier of an item & Serial & Foreign key that refers to ID of Item, Primary key with Contract\_ID \\\cline{2-5}
& Contract\_ID & Identifier of a contract & Serial &  Foreign key that refers to ID of Contract, Primary key with Item\_ID\\\cline{2-5}
...
& Description & Description of a contract & Text & NOT NULL\\\cline{2-5}
...
& Supplier\_ID & Identifier of a supplier & Int  & Foreign Key that refers to VAT\_number of Supplier \\\cline{2-5}
& Employee\_ID & Identifier of an employee & Text & Foreign Key that refers to TAX\_number of Employee \\\hline
...
& Order\_ID & Identifier of an Order of the order payment & Serial & Foreign Key that refers to ID of Order \\\hline
...
\multirow{4}{*}{Ship} & Employee\_ID & Identifier of employee that ships the order & Serial &  Foreign key to Employee, Primary key with Order\_ID \\\cline{2-5}
& Order\_ID & Identifier of the shipping order & Serial & Foreign key to Order, Primary key with Employee\_ID \\\cline{2-5}
& Shipping\_date & date of when the order leaves to be shipped & Datetime & NOT NULL \\\cline{2-5}
& Track\_num & shipment code given by the third-party shipping company & Text & \\\hline
...
& Role\_ID & Identifier of the role that an employee has & Enumeration & Foreign Key to Role, enumeration in {Manager, Salesman, Worker, Data Analyst}\\\hline
