\begin{longtable}{|p{.20\columnwidth}|p{.20\columnwidth} |p{.30\columnwidth}|p{.25\columnwidth} |}
    ...
    \begin{itemize}
        ...
        \item Department\_ID:   department identifier, serial
    \end{itemize}
    &  TAX\_number \\\hline
    ...
    \begin{itemize}
        ...
        \item Supplier\_ID:   supplier identifier, serial        % length=11
    ...
    \begin{itemize}
        \vspace{-1em}
        \item VAT\_number:   VAT number of the supplier company, serial
